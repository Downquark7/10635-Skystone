...
@TeleOp
public class MattandEvanTeleOpRemastered2 extends LinearOpMode {
    ...
    boolean previousGamepad2y = false;
    boolean previousGamepad2x = false;
    boolean previousGamepad2a = false;
...
//        robot.RightIntake.setPower(1);
        ...
        while (opModeIsActive()) {
            ...
            double triggerSum = gamepad1.right_trigger - gamepad1.left_trigger + gamepad2.right_trigger - gamepad2.left_trigger - gamepad2.right_stick_y;
...
//                    }
                ...
                if (prevElbowEnc != elbowPosition)
                    elbowTimer.reset();
                prevElbowEnc = elbowPosition;
                if (!elbowExtended && elbowTimer.milliseconds() > 50) {
